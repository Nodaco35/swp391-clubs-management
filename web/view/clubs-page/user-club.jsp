...
<html>
    ...
    <body class="bg-gray-100 font-sans antialiased" >
        ...
        <div  style="display: flex; flex-direction: column">
            ...
            <div class="container mx-auto max-w-6xl bg-white rounded-2xl shadow-xl p-6 my-8" style="padding-bottom: 5%">
                ...
                <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" id="errorModal">
                    <div class="bg-white rounded-lg w-full max-w-md">
                        <div class="bg-red-500 text-white p-4 rounded-t-lg flex justify-between items-center">
                            ...
                            <button type="button" class="text-2xl" onclick="document.getElementById('errorModal').classList.add('hidden')">&times;</button>
                        </div>
                        <div class="p-6">
                            <p>${error}</p>
                        </div>
                        <div class="p-4 border-t border-gray-200 text-right">
                            <button type="button" class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition" onclick="document.getElementById('errorModal').classList.add('hidden')">Đóng</button>
                        </div>
                    </div>
                </div>
            </c:if>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                ...
                <a href="#" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition" onclick="toggleAddForm()">Thêm thành viên</a>
            </div>

            <!-- Bảng danh sách thành viên -->
            <div class="overflow-x-auto">
                <table class="w-full border-collapse bg-white rounded-lg shadow">
                    <thead class Oswald bg-gray-800 text-white">
                        <tr>
                        ...
                        <c:forEach var="uc" items="${userClubs}">
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="p-3 border-b flex gap-2">
                                    <a href="#" class="bg-yellow-500 text-white px-3 py-1 rounded-lg hover:bg-yellow-600 transition" onclick="toggleEditForm(${uc.userClubID}, '${uc.userID}', ${uc.departmentID}, ${uc.roleID}, ${uc.isActive})">Sửa</a>
            ...
            <div class="hidden bg-gray-50 p-6 rounded-lg shadow-inner mt-6" id="memberForm">
                ...
                <form action="${pageContext.request.contextPath}/club-members" method="post" id="memberFormData" class="space-y-4">
                    <input type="hidden" name="clubID" value="${clubID}">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="isActive" id="isActive" value="true" class="h-4 w-4 text-blue-500 focus:ring-blue-500 border-gray-300 rounded">
