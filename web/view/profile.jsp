...
<!--         Date of Birth 
        ...
        <!-- Send OTP Button -->
        <div class="mb-3">
            <button type="button" class="btn btn-secondary" id="sendOtpBtn">Gửi mã OTP</button>
        </div>
        <!-- Submit Button -->
        <div class="mb-3">
...
<script>
    document.getElementById('sendOtpBtn').addEventListener('click', function() {
        ...
        if (emailInput !== originalEmail) {
            fetch('home?action=sendOtp', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                },
                body: 'email=' + encodeURIComponent(originalEmail)
            })
            ...
            alert('Vui lòng nhập email mới khác với email hiện tại.');
        }
    });
</script>
</body>
