        ...
        <div class="tabs">
            ...
            <div id="editTab" class="tab-content active">
                ...
                <div id="questionsList" class="questions-list">
                    <%-- Các câu hỏi mặc định. JS sẽ xóa nếu có existingQuestions và tạo lại từ dữ liệu. --%>                    <!-- Question 1: Họ và tên (Required) -->
                    <div class="card question-card required-question" data-id="qDefault1" draggable="true">
                        <div class="card-header">
                            ...
                            <div class="question-actions">
                                ...
                                <button class="btn-icon delete" title="Xóa" disabled>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="card-content">
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input question-label" value="Họ và tên" readonly>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="checkbox-wrapper">
                                    <input type="checkbox" id="required-qDefault1" class="question-required" checked disabled>
                                    <label for="required-qDefault1">Bắt buộc</label>
                                </div>
                            </div>
                        </div>
                    </div><!-- Question 2: Email (Required) -->
                    <div class="card question-card required-question" data-id="q2" draggable="true">
                        ...
                        <div class="card-content">
                            <div class="form-row">
                                <div class="form-group">
                                    <label class="form-label">Nhãn câu hỏi</label>
                                    <input type="text" class="form-input question-label" value="Email" readonly>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Loại câu hỏi</label>
                                    <select class="form-select question-type" disabled>
                            ...
                            <div class="form-group">
                                <div class="checkbox-wrapper">
                                    <input type="checkbox" id="required-qDefault2" class="question-required" checked disabled>
                                    <label for="required-qDefault2">Bắt buộc</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    
                    <!-- Question 3: Chọn ban muốn vào CLB (Required) -->
                    <div class="card question-card required-question" data-id="qDepartment" draggable="true">
                        <div class="card-header">
                            <div class="question-header">
                                <div class="drag-handle">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    <c:forEach var="department" items="${clubDepartments}" varStatus="status">
                                        <div class="option-item" data-id="opt-dept-${department.departmentId}">
                                            <div class="option-header">
                                                ...
                                                <button class="btn-icon delete-option" title="Xóa tùy chọn" disabled>
