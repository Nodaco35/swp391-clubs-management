                ...
                <%@ page import="util.StringEscapeUtils" %>
                    <%@ page import="models.ApplicationFormTemplate" %> <%-- Import model ApplicationFormTemplate --%>
                            ...
                            <body>
                                            ...
                                            <div id="saveSuccessAlert" class="alert alert-success">
                                                ...
                                                <div class="alert-content">
                                                    <h4 class="alert-title">
                                                        <c:choose>
                                                            <c:when test="${param.action == 'publish'}">Đã xuất bản
                                                                thành công</c:when>
                                                    ...
                                                    <p class="alert-description">
                                                        <c:choose>
                                                            <c:when test="${param.action == 'publish'}">Form của bạn đã
                                                                được xuất bản và có thể sử dụng.</c:when>
                                                            <c:otherwise>Form của bạn đã được lưu thành công.
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </p>
                                                </div>
                                        ...
                                        <div class="tabs">
                                            ...
                                            <div id="editTab" class="tab-content active">
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="formType" name="formType"
                                                                ...
                                                                onchange="toggleEventField(this)" required>
                                                                <option value="">Chọn loại form</option>
                                                                <option value="event" ${formTypeToEdit=='Event'
                                                                    ? 'selected' : '' }>Đăng ký tham gia sự kiện
                                                                </option>
                                                                <option value="member" ${formTypeToEdit=='Club'
                                                                    ? 'selected' : '' }>Đăng ký làm thành viên</option>
                                                            </select>
                                                            <div class="error-feedback" id="formTypeError"
                                                                style="color: #dc3545; font-size: 0.875rem; margin-top: 5px; display: none;">
                                                ...
                                                <div class="section-header">
                                                    <h2 class="section-title">Câu hỏi (<span
                                                            id="questionCount">0</span>/20)</h2>
                                                ...
                                                <!-- Max Questions Alert -->
                                                <div id="maxQuestionsAlert" class="alert alert-warning"
                                                    style="display: none;">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <div class="alert-content">
                                                        ...
                                                        <p class="alert-description">Bạn đã đạt đến giới hạn 20 câu hỏi
                                                            cho mỗi form.</p>
                                                    </div>
                                                </div> <!-- Questions List -->
                                                <div id="questionsList" class="questions-list">
                                                    <%-- Các câu hỏi mặc định. JS sẽ xóa nếu có existingQuestions và tạo
                                                        lại từ dữ liệu. --%>
                                                        <!-- Question 1: Chọn ban muốn vào CLB (Required) -->
                                                        <div class="card question-card required-question"
                                                            id="departmentQuestion" data-id="departmentQuestion"
                                                            data-required-type="department" draggable="true">
                                                            <div class="card-header">
                                                                ...
                                                                <div class="question-actions">
                                                                    <button class="btn-icon move-up"
                                                                        title="Di chuyển lên" disabled>
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                    ...
                                                                    <button class="btn-icon move-down"
                                                                        title="Di chuyển xuống" disabled>
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="16" height="16" viewBox="0 0 24 24"
                                                                            fill="none" stroke="currentColor"
                                                                            stroke-width="2" stroke-linecap="round"
                                                                    ...
                                                                    </button> <button class="btn-icon delete"
                                                                        title="Xóa">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="16" height="16" viewBox="0 0 24 24"
                                                                            fill="none" stroke="currentColor"
                                                            ...
                                                            <div class="card-content">
                                                                <div class="form-row">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"
                                                                            class="form-input question-label"
                                                                            value="Chọn ban muốn vào CLB">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="form-label">Loại câu hỏi</label>
                                                                        <select class="form-select question-type"
                                                                            disabled>
                                                                            <option value="radio" selected>Trắc nghiệm
                                                                                (một lựa chọn)</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="checkbox-wrapper">
                                                                        <input type="checkbox" id="required-qDepartment"
                                                                            class="question-required" checked disabled>
                                                                        <label for="required-qDepartment">Bắt
                                                                            buộc</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div id="previewTab" class="tab-content">
                                                <div class="preview-container">
                                                    <div class="card preview-card">
                                                        <div class="card-header">
                                                            <h2 id="previewTitle" class="card-title">Đơn đăng ký tham
                                                                gia câu lạc bộ</h2>
                                                        </div>
                                                        <div class="card-content">
                                                        ...
                                                        <div class="card-footer">
                                                            <button type="button" class="btn btn-primary btn-block">Gửi
                                                                đơn đăng ký</button>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="publishDialog" class="dialog">
                                    ...
                                    <div class="dialog-content">
                                        ...
                                        <div class="dialog-body">
                                            <p>Khi xuất bản, form này sẽ được công khai và có thể được sử dụng để đăng
                                                ký.</p>
                                    ...
                                    <div class="card question-card" data-id="{{id}}">
                                        ...
                                        <div class="card-content">
                                            <div class="form-row">
                                                <div class="form-group">
                                                    <label class="form-label">Nhãn câu hỏi</label>
                                                    <input type="text" class="form-input question-label"
                                                        value="Câu hỏi mới">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Loại câu hỏi</label>
                                            ...
                                            <div class="form-group placeholder-group">
                                                ...
                                                <input type="text" class="form-input question-placeholder"
                                            ...
                                            <div class="form-group info-group" style="display: none;">
                                                ...
                                                <textarea class="form-textarea question-content" rows="4"
                                                    placeholder="Nhập nội dung thông tin..."></textarea>

                                                <label class="form-label">Hình ảnh</label>
                                                <div class="image-upload-container">
                                                    <input type="file" class="form-input question-image-file"
                                                    ...
                                                    <div class="image-upload-area"
                                                        ...
                                                        <div class="image-preview-container" style="display: none;">
                                                            ...
                                                            <div class="image-actions">
                                                                <button type="button" class="btn-icon change-image"
                                                                    title="Thay đổi ảnh">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                        height="16" viewBox="0 0 24 24" fill="none"
                                                                        stroke="currentColor" stroke-width="2"
                                                                ...
                                                                <button type="button" class="btn-icon remove-image"
                                                                    title="Xóa ảnh">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                        height="16" viewBox="0 0 24 24" fill="none"
                                                                        stroke="currentColor" stroke-width="2"
                                ...
                                <form id="formBuilderForm" action="${pageContext.request.contextPath}/formBuilder"
                                    ...
                                    <%-- Truyền editingFormId nếu đang ở chế độ chỉnh sửa --%>
                                        <c:if test="${not empty editingFormId}">
                                            <input type="hidden" name="editingFormId"
                                                value="${fn:escapeXml(editingFormId)}">
                                        </c:if>
                                </form>
                                </form>
                                ...
                                <div class="back-to-top visible" id="backToTop"
                                    style="position: fixed; bottom: 20px; right: 20px; width: 40px; height: 40px; background-color: #00a6c0; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; z-index: 1000; opacity: 1; visibility: visible;">
