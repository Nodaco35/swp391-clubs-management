...
<%--			<h3><i class="fas fa-file-alt"></i> ${dept.name}</h3>--%>
<%--			<p>${dept.description}</p>--%>
<%--			<div class="department-stats">--%>
<%--				<span class="member-count">${dept.memberCount} thành viên</span>--%>
<%--				<span class="department-leader">Trưởng phòng: ${dept.leader}</span>--%>
<%--			</div>--%>
<%--		</div>--%>
		<div class="departments-grid" id="departmentsGrid">
