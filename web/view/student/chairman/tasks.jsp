	                            ...
	                            <div class="timeline-item">
	                                ...
	                                <div class="timeline-phases">
	                                    <c:forEach var="task" items="${tasks}">
	                                        <div class="phase-item ${task.status == 'Done' ? 'completed' : 'ongoing'}">
	                                            <div class="phase-connector"></div>
	                                            <div class="phase-content">
	                                                <div class="phase-header">
	                                                    <h4>${task.term}</h4>
	                                                    <span class="phase-status ${task.status == 'Done' ? 'completed' : 'ongoing'}">${task.status}</span>
	                                                </div>
	                                                <p class="phase-description">${task.description}</p>
	                                                <div class="phase-info">
	                                                    <div class="phase-dates">
	                                                        <i class="fas fa-calendar"></i>
	                                                        <fmt:formatDate value="${task.termStart}" pattern="dd/MM/yyyy" /> -
	                                                        <fmt:formatDate value="${task.termEnd}" pattern="dd/MM/yyyy" />
	                                                    </div>
	                                                    <div class="phase-departments">
	                                                        <i class="fas fa-users"></i>
	                                                        <c:forEach var="d" items="${task.departments}" varStatus="loop">
