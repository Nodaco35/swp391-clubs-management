                                                    ...
                                                    <div class="bg-white rounded-lg shadow-md p-6 border border-gray-150 hover:shadow-lg transition">
                                                        <div class="flex items-center gap-6">
                                                            ...
                                                            <div>
                                                                ...
                                                                <h2 class="text-xl font-medium text-gray-800">${cm.meetingTitle}</h3>
                                                                    ...
                                                                    <c:if test="${not empty cm.document}">
                                                                        <p class="text-sm text-gray-600">
                                                                            Link: <strong><a href="${cm.document}" target="_blank" class="text-blue-600 underline">${cm.document}</a></strong>
                                                                        </p>
                                                                    </c:if>
