                ...
                <form method="GET" class="row g-3" id="filterForm">
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select" id="statusFilter" name="status">
                            ...
                            <option value="InProgress" ${param.status == 'InProgress' ? 'selected' : ''}>Đang thực
                                hiện
                            </option>
                    ...
                    <div class="col-md-2">
                        ...
                        <select class="form-select" id="sortBy" name="sortBy">
                            ...
                            <option value="startDate" ${param.sortBy == 'startDate' ? 'selected' : ''}>Ngày bắt đầu
                            </option>
                            <option value="endDate" ${param.sortBy == 'endDate' ? 'selected' : ''}>Ngày kết thúc
                            </option>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>Phụ trách</th>
                                    <th>
                                        <a href="javascript:void(0)" onclick="sortBy('startDate')"
                                           class="text-decoration-none text-dark">
                                            Thời gian
                                    ...
                                    <th>
                                        <a href="javascript:void(0)" onclick="sortBy('createdAt')"
                                           class="text-decoration-none text-dark">
                                            Người tạo
                                                    ...
                                                    <c:when test="${not empty task.endDate}">
                                                        ...
                                                        <c:if test="${task.endDate.time < now.time && task.status != 'Done'}">
                                                            <br><small class="text-danger"><i
                                                                class="fas fa-exclamation-triangle"></i> Quá hạn</small>
                                                        </c:if>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <span class="text-muted">Chưa xác định</span>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="taskTitle" class="form-label">Tiêu đề nhiệm vụ <span
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="taskDescription" class="form-label">Mô tả nhiệm vụ <span
                                    class="text-danger">*</span></label>
                            <textarea class="form-control" id="taskDescription" name="description" rows="4" required
                                      maxlength="1000"
                                      placeholder="Mô tả chi tiết nhiệm vụ cần thực hiện..."></textarea>
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="assignedTo" class="form-label">Người phụ trách <span
                                    class="text-danger">*</span></label>
                            <div class="position-relative">
                                ...
                                <div id="memberDropdown" class="dropdown-menu position-absolute w-100"
                                     style="display: none; max-height: 250px; overflow-y: auto; z-index: 1050;">
                                    <!-- Search results will appear here -->
                                </div>
                                <div id="selectedMemberDisplay" class="mt-2 p-2 border rounded bg-light"
                                     style="display: none;">
                                    <div class="d-flex align-items-center">
                                        <img id="selectedAvatar" src="" class="rounded-circle me-2"
