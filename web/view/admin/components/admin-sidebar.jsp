...
<aside class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="${pageContext.request.contextPath}/admin/events"><i class="fas fa-calendar-alt"></i> Quản lý sự kiện</a></li>
        <li><a href="${pageContext.request.contextPath}/admin/users"><i class="fas fa-user"></i> Quản lý người dùng</a></li>
