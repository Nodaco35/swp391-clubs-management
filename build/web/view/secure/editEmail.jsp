    ...
    <body class="bg-gray-100 flex items-center justify-center min-h-screen">
        ...
        if (request.getAttribute("msg") != null) { %>
            ...
            <form action="verifyCode?action=sendOtp" method="POST" class="space-y-4">
                ...
                <%if(msg != null) {%>
                <p class="text-center text-gray-600 mb-4"><%= msg%></p>
                <%}%>
                <button type="submit"
            ...
            <p class="mt-4 text-center text-sm text-gray-600">
                <a href="${pageContext.request.contextPath}/" class="${pageContext.request.servletPath == '/index.jsp' ? 'active' : ''}" class="text-indigo-600 hover:underline">Quay lại trang chủ</a>
            </p>
        </div>
    </body>
</html>