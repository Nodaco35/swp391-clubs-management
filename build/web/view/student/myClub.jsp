            ...
            <main class="ml-64 flex-1 p-6">
                ...
                <div class="container mx-auto px-4 py-8">
                    <section class="mb-10">
                        ...
                        <div class="grid grid-cols-4 gap-4 mb-6">
                            <div class="p-4 bg-white rounded-lg shadow-md border border-gray-200 flex items-center">
                                ...
                                <div>
                                    <p class="text-sm text-gray-600">Số nhiệm vụ cần làm</p>
                    ...
                    <section id="calendar" class="mb-10">
                        <h2 class="text-3xl font-semibold text-black mb-6">Nhiệm Vụ Của Tôi</h2>
                        <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                            <c:choose>
                                <c:when test="${empty todoList}">
                                    <p class="text-gray-600 text-center py-4">Không có nhiệm vụ nào.</p>
                                </c:when>
                                <c:otherwise>
